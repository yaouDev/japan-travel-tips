...
Typically, you order one main dish which is accompanied by rice. If you order a set menu you will most likely have things like miso soup, salad (typically cabbage), tsukemono (pickled vegetables), or other more meal-specific items such as raw egg, konbu, tenkasu, katsuobushi, etc.

Other meals, such as ramen, will be the foundational dish and you'll get to choose specific toppings, though, a lot of meals are served as set menus.

In general, the japanese diet is heavy on rice, fish, and soy/sodium. It can be difficult to get consistent vegan meals as even chefs are sometimes unaware of what contains animal-based products (e.g., dashi). Roots are also very common; daikon, renkon (lotus root), sweet potato (different variety than european!), wasabi (many different parts of the plant), etc. NOTE: "wasabina" is *not* wasabi paste; it's the leaves of the root.

As far as beverages are concerned you'd typically be served water and/or tea (esp. hot tea in the winter). Ordering a beer to go along with your food is not uncommon either, but you seldom see japanese people order anything else (except in places like McD). That said, sodas and whatnot are usually available from the menu.

Spices and sauces available at the table will typically be salt, soy, and shichimi (seven spices).
...
Note that breaking etiquette is fine, but at least be aware that you are.
...
* Don't pierce your food with your chopsticks
* Don't put your chopsticks upright in rice - it's a funeral tradition and you might be told off for it



### Sushi

* Don't add wasabi - it's already under the fish
* Don't dip the rice in soy - only the fish (turn it over)
* Eat it in one bite
* Yes, you can remove the shrimp tail if you'd like
* Traditionally it's meant to be finger food, though, reactions may vary
* Don't ask for swap-outs if you're ordering a set menu



### Noodles

* No, slurping does not mean you're "telling the chef it's tasty" - it will, however, help cool the scorching hot noodles you will be served. Seriously, you'll get burns if you don't.
* Some places offer bibs - it may seem stupid but if you're wearing white I'd recommend wearing one
...
Every link will be to Google Maps.
...
August's recommended order (might be omitted in generic cases)
...
* 喜んで　(yorokonde) - Gladly { Might be said at an eccentric izakaya }
* お預かりいたしました　(oazukari itashimashita) - I've received (your money) { usu. said by person handling your payment, no reply necessary }
* 召し上がってください / 召し上がれ (meshiagattekudasai / meshiagare) - Enjoy your meal { Respond with thank you (or silence) }
* 自由に (jiyuu ni) - at will / freely { e.g., when there's a salad bar / soda fountain / etc }
* 以上で (ijou de) - That's all { used at the end of your order }
...
* お冷 / 水 (ohiya / mizu) - (cold) water { ohiya is mainly drinking water (in a restaurant) }
* お茶 (ocha) - (green) tea
* 食べ放題 (tabehoudai) - all-you-can-eat
* 飲み放題 (nomihoudai) - all-you-can-drink
* ストレート (sutoreeto) - straight / neat { of liquor }
* ロックで (rokku de) - on the rocks { of liquor }
* 水割り (mizuwari) - mixed with water { of liquor }
